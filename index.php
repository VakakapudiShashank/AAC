<?php 
    $page_title = "Andhra Angel Networks - Home";
...
?>
        ...
        <section id="glimpses" class="page-section light-bg-override"> 
            <div class="container">
                <p class="section-heading-guaranteed">Glimpses of Our Journey</p>
                <p class="section-subtitle-alt">Moments from our events, workshops, and collaborative spaces.</p>
        ...
        <section id="collaborations" class="page-section light-bg-override">
            <div class="container">
                <p class="section-heading-guaranteed">Our Collaborations</p>
                <p class="section-subtitle">Building partnerships across the innovation ecosystem</p>

                <div class="collaboration-tabs">
                    <div class="tab-buttons">
                        <button class="tab-link" data-tab="school-partners">School Partnerships</button>
                        <button class="tab-link" data-tab="college-partners">College Partnerships</button>
                    ...
                    <div id="govt-partners" class="tab-content">
                        <div class="partner-grid-2col">
                            ...
                            <div class="partner-card-desc">
                                <h3>MSME</h3>
                                <p>Micro, Small & Medium Enterprises development support.</p>
                            </div>

                            <div class="partner-card-desc">
                                <h3>DST</h3>
                                <p>Department of Science & Technology innovation initiatives.</p>
                            </div>

                            <div class="partner-card-desc">
                                <h3>MeitY</h3>
                                <p>Ministry of Electronics & IT digital innovation programs.</p>
                            </div>

                            <div class="partner-card-desc">
                                <h3>AP-MSME</h3>
                                <p>Conducting Awareness Session of EAP</p>
                            </div>

                            <div class="partner-card-desc empty-card">
                                <h3>T-HUB</h3>
                                <p>&nbsp;</p> </div>
        ...
        <section id="contact" class="page-section light-bg-override">
            <div class="container contact-grid">
                <div class="contact-info">
                    <p class="section-heading-guaranteed">Contact Us</p>
                    <p class="section-subtitle">Get in Touch with Our Team</p>
                    
                    <h3 class="build-heading">Let's Build Together 🚀</h3>
